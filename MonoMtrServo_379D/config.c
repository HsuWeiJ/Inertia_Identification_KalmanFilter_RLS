...
// ****************************************************************************
// ****************************************************************************
// SPIDAC GPIO Configuration
// ****************************************************************************
// ****************************************************************************
void InitSpiDacGpio(void)
{
    // set up SDI pin
    GPIO_SetupPinOptions(SPIDAC_MOSI_GPIO, GPIO_INPUT, GPIO_ASYNC);
    GPIO_SetupPinMux(SPIDAC_MOSI_GPIO,0,SPIDAC_MOSI_MUX);

    // set up SDO pin
    GPIO_SetupPinOptions(SPIDAC_MISO_GPIO, GPIO_INPUT, GPIO_ASYNC);
    GPIO_SetupPinMux(SPIDAC_MISO_GPIO,0,SPIDAC_MISO_MUX);

    // set up CLK pin
    GPIO_SetupPinOptions(SPIDAC_CLK_GPIO, GPIO_INPUT, GPIO_ASYNC);
    GPIO_SetupPinMux(SPIDAC_CLK_GPIO,0,SPIDAC_CLK_MUX);

    // set up SCS pin
    GPIO_SetupPinOptions(SPIDAC_CS_GPIO, GPIO_OUTPUT, GPIO_ASYNC);
    GPIO_SetupPinMux(SPIDAC_CS_GPIO,0,SPIDAC_CS_MUX);
