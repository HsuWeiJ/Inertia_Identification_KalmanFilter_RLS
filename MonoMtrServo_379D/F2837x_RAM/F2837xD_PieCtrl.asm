...
;* Date/Time created: Thu Dec 29 14:08:20 2022                 *
;***************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../F2837xD_PieCtrl.c")
...
;	C:\ti\ccs1040\ccs\tools\compiler\ti-cgt-c2000_20.2.5.LTS\bin\opt2000.exe C:\\Users\\jason\\AppData\\Local\\Temp\\{06822468-33CE-44A4-B3D3-8C1600145451} C:\\Users\\jason\\AppData\\Local\\Temp\\{AC33F1D5-7E8F-41D7-AB80-7E57FA1CFBF8} 
;	C:\ti\ccs1040\ccs\tools\compiler\ti-cgt-c2000_20.2.5.LTS\bin\ac2000.exe -@C:\\Users\\jason\\AppData\\Local\\Temp\\{18654800-C78A-4643-A9FB-E98B3EA1661B} 
	.sect	".text"
	.clink
	.global	_InitPieCtrl
...
$C$DW$2	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$2, DW_AT_TI_begin_file("../F2837xD_PieCtrl.c")
	.dwattr $C$DW$2, DW_AT_TI_begin_line(0x18)
	.dwattr $C$DW$2, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$2, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../F2837xD_PieCtrl.c",line 25,column 1,is_stmt,address _InitPieCtrl,isa 0
...
_InitPieCtrl:
 ...
 setc INTM
	...
	.dwpsn	file "../F2837xD_PieCtrl.c",line 34,column 5,is_stmt,isa 0
        AND       @$BLOCKED(_PieCtrlRegs),#0xfffe ; [CPU_ALU] |34| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 39,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+2,#0 ; [CPU_ALU] |39| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 40,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+4,#0 ; [CPU_ALU] |40| 
        SPM       #0                    ; [CPU_ALU] 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 41,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+6,#0 ; [CPU_ALU] |41| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 42,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+8,#0 ; [CPU_ALU] |42| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 43,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+10,#0 ; [CPU_ALU] |43| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 44,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+12,#0 ; [CPU_ALU] |44| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 45,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+14,#0 ; [CPU_ALU] |45| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 46,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+16,#0 ; [CPU_ALU] |46| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 47,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+18,#0 ; [CPU_ALU] |47| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 48,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+20,#0 ; [CPU_ALU] |48| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 49,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+22,#0 ; [CPU_ALU] |49| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 50,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+24,#0 ; [CPU_ALU] |50| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 55,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+3,#0 ; [CPU_ALU] |55| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 56,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+5,#0 ; [CPU_ALU] |56| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 57,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+7,#0 ; [CPU_ALU] |57| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 58,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+9,#0 ; [CPU_ALU] |58| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 59,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+11,#0 ; [CPU_ALU] |59| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 60,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+13,#0 ; [CPU_ALU] |60| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 61,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+15,#0 ; [CPU_ALU] |61| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 62,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+17,#0 ; [CPU_ALU] |62| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 63,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+19,#0 ; [CPU_ALU] |63| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 64,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+21,#0 ; [CPU_ALU] |64| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 65,column 2,is_stmt,isa 0
        MOV       @$BLOCKED(_PieCtrlRegs)+23,#0 ; [CPU_ALU] |65| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 66,column 2,is_stmt,isa 0
...
$C$DW$3	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$3, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$2, DW_AT_TI_end_file("../F2837xD_PieCtrl.c")
...
$C$DW$4	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$4, DW_AT_TI_begin_file("../F2837xD_PieCtrl.c")
	.dwattr $C$DW$4, DW_AT_TI_begin_line(0x48)
	.dwattr $C$DW$4, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$4, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../F2837xD_PieCtrl.c",line 73,column 1,is_stmt,address _EnableInterrupts,isa 0
...
_EnableInterrupts:
	...
	.dwcfi	save_reg_to_mem, 26, 0
        MOVW      DP,#_PieCtrlRegs      ; [CPU_ARAU] 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 77,column 5,is_stmt,isa 0
        OR        @$BLOCKED(_PieCtrlRegs),#0x0001 ; [CPU_ALU] |77| 
	.dwpsn	file "../F2837xD_PieCtrl.c",line 82,column 2,is_stmt,isa 0
...
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$4, DW_AT_TI_end_file("../F2837xD_PieCtrl.c")
